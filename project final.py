...
#API key connection
def Api_connect():
    Api_Id="AIzaSyBZeMHYHAANssF4oWWGSC7ybAHwpDctzZ4"
...
client=pymongo.MongoClient('mongodb+srv://jaisrikumaresan:Jessikumar@cluster0.ktt6xqb.mongodb.net/?retryWrites=true&w=majority')
